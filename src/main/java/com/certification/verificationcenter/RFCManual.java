...
public class RFCManual
    ...
    public static final ASN1ObjectIdentifier ogrn = new ASN1ObjectIdentifier("1.2.643.7.1.1.2.3").intern();
     ...
     * Singleton instance.
     */
    public static final X500NameStyle INSTANCE = new RFCManual();
